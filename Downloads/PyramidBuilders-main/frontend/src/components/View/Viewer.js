        ...
        return (
            <div>
                <div class="containerNew">
                    ...
                    <div class="Info-text">
                        <h1>Information</h1>
                            <h3 className="speec"><b className="speech">Title:</b> {movieData.Title}</h3>
                            <h3 className="speec"><b className="speech">Type:</b> {movieData.Type}</h3>
                            <h3 className="speec"><b className="speech">Year of Release:</b> {movieData.Year}</h3>
                            <h3 className="speec"><b className="speech">Average Rating:</b></h3>
                            <h3 className="speec"><b className="speech">Plot Synopsis:</b> {movieData.Plot}</h3>
                    </div> 
                    </div>
                        <div className="Write">
