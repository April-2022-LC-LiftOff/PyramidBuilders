...
export default function Profile() {
	...
	const usrBio =
		...
		else if (reviewStars === 1) { StarFill, Star, Star, Star, Star }
		else if (reviewStars === 2) { StarFill, StarFill, Star, Star, Star }
		else if (reviewStars === 3) { StarFill, StarFill, StarFill, Star, Star }
		else if (reviewStars === 4) { StarFill, StarFill, StarFill, StarFill, Star }
		else { StarFill, StarFill, StarFill, StarFill, StarFill }
			...
			<Row className="profile-page">
				...
				<Col sm={5}>
					<div className="col-review-cards">
						...
						<Card style={{ flexDirection: "row", height: "200px" }}>
							<Card.Img variant="top" src={reviewTwo} style={{ size: "sm" }} />
							<Card.Body>
						...
						<Card style={{ flexDirection: "row", height: "200px" }}>
							<Card.Img variant="top" src={reviewThree} style={{ size: "sm" }} />
							<Card.Body>
						...
						<Card style={{ flexDirection: "row", height: "200px" }}>
							<Card.Img variant="top" src={reviewFour} style={{ size: "sm" }} />
							<Card.Body>
