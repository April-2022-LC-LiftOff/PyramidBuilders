...
const Viewer = (props) => {
	...
	const ReviewPullApiUrl =
		"http://localhost:8080/api/review/getAll?movieId=" + movieId;
	const movieAPIPull = "http://www.omdbapi.com/?apikey=84a99a76&i=" + movieId;
	const ratingPull =
		"http://localhost:8080/api/review/getAvgRating?movieId=" + movieId;
			...
			<div class="containerNew">
				...
				<div class="Info">
					<div class="Info-text">
						...
						<h3>
							Average Rating:{" "}
							{showStarRating(averageRating.valueOf())}
						</h3>
