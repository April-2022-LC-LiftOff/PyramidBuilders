    ...
    render() {
        ...
        <div >
            ...
            <form className="Form FormContainer" onSubmit={this.handleSubmit}>
                    ...
                    onChange = {(e) => this.rating = e.target.value} className="Input username" placeholder="Rate the movie" />
                ...
                <button type="submit" name="btn" className="SubmitButton" onClick={this.handleSubmit}>Save Review</button>
                </form>
        </div>
    </div>
    )
